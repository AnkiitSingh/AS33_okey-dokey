...
class ImoList extends Component {
    ...
    render() {
        ...
        const checker = () => {
            ...
            if (data.length === 0) {
                return (
                    <div className="text-center fill-form">Fill the IMO registration no. to get details !</div>
                )
            }
            return (
                ...
                <div className="core-page-pad">
                    ...
                    <div className="form-background">
                        ...
                        <div className="search-content text-center">
                            <input onChange={handleChange("find")} className="search-bar" placeholder="Enter IMO Id."></input>
                            <br /><br />
